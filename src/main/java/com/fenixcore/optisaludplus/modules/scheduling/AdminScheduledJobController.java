package com.fenixcore.optisaludplus.modules.scheduling;

import com.fenixcore.optisaludplus.modules.scheduling.dto.ManualRunResponse;
...
import com.fenixcore.optisaludplus.modules.scheduling.entity.ScheduledJobRun.Outcome;
...
import com.fenixcore.optisaludplus.modules.scheduling.service.ManualRunResult;
import com.fenixcore.optisaludplus.modules.scheduling.service.ScheduledJobsService;
...
public class AdminScheduledJobController {
    ...
    public ResponseEntity<Page<ScheduledJobDto>> list(
        ...
        return ResponseEntity.ok(jobsService.list(pageable, filter, q));
    }
