 ...
 *
 * <p>Reads are gated by {@code CORPORATE_CONTRACT_VIEW_ALL}, all mutations
 * (CRUD + bulk enroll) by {@code CORPORATE_CONTRACT_MANAGE} — both seeded in
 * the MEMBERS permission domain by V38. Pagination follows the project
 * convention: page size 20, {@code createdAt} DESC (newest first).</p>
 */
@RestController
...
public class AdminCorporateContractController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('CORPORATE_CONTRACT_MANAGE')")
