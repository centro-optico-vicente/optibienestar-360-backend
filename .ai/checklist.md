...
- [ ] [P0/C2] Crear estructura `.ai/` en este repo (CLAUDE, README, checklist subset)
- [ ] [P1/C1] Instalar skill `spring-boot-best-practices`
- [ ] [P1/C1] Instalar skill `postgresql-expert`
- [ ] [P1/C1] Instalar skill `redis-expert`
- [ ] [P1/C1] Instalar skill `owasp-security`
